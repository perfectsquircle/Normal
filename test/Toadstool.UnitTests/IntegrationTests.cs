...
namespace Toadstool.UnitTests
{
    public class IntegrationTests
    {
        ...
        {
            yield return new object[] { (CreateConnection)(() => new NpgsqlConnection("Host=localhost;Database=postgres;Username=postgres;Password=toadstool")) };
            yield return new object[] { (CreateConnection)(() => new SqlConnection("Server=localhost;Uid=SA;Pwd=Toadstool123")) };
        }
    }
}